...
goog.provide('Turtle_Collab.Blocks');
...
Blockly.JavaScript['arbitrary_number'] = Blockly.JavaScript['math_number'];
...
Blockly.Blocks['turtle_arbitrary_internal'] = {
  /**
   * Block for arbitrary code.
   * @this Blockly.Block
   */
...
Blockly.JavaScript['turtle_arbitrary'] = function(block) {
   ...
   */
   ...
   return Blockly.JavaScript.valueToCode(block, 'SCRIPT', Blockly.JavaScript.ORDER_NONE)
};

Blockly.JavaScript['turtle_arbitrary_internal'] = function(block) {
  /**
   * Block for arbitrary code.
   * @this Blockly.Block
   */
